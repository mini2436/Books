...
/// Drop-in localized counterpart to Flutter's [material.Text].
///
/// Existing Chinese UI copy remains the stable source key, while English
/// translations are resolved from the nearest [AppLocalizations] instance.
  ...
  material.Widget build(material.BuildContext context) {
    return material.Text(
      ...
      semanticsLabel: semanticsLabel == null
          ? null
          : AppLocalizations.of(context).tr(semanticsLabel!),
